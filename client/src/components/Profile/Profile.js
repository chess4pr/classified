...
class Profile extends Component {
    ...
    render() {
        ...
        /*if (user.username === 'admin') {
            adminInfo = <pre><br/><br/>admin section<hr className="border-primary"/><p>Сайт прототип: https://claz.org/</p><p>CMS: https://vazoga.com:1337/admin</p> {JSON.stringify(process.env)}<br/><br/><br/> </pre>
        }*/
        return <section className="container">
